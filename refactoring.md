...
- [ ] Update `refactoring.md` (this file) as items are completed
- [ ] Update `appstore_page.md` if exists
- [ ] Update any documentation in `docs/` directory

#### 5.2 Metadata
- [ ] Update `privacy-policy.md` if app name is mentioned
...
- [ ] Place new GoogleService-Info.plist in JourneyWallet/ directory
- [ ] Update Firebase configuration in all environments

#### 6.2 iCloud Configuration
- [ ] Update iCloud container in Apple Developer Portal
- [ ] Update entitlements with new container identifier
